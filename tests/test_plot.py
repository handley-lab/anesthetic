...
class TestPlotAnesthetic(TestPlotBase):
    def test_AxesObjects(self):
        paramnames = ['a', 'b', 'c']
    ...
    def test_2d_axes_axlines(self, axesparams, params, upper):
    ...
    @pytest.mark.parametrize('params', [{'A': 0},
                                        ...
                                        {'A': [0, 0.1], 'C': [0, 0.5]}])
    @pytest.mark.parametrize('upper', [True, False])
    def test_2d_axes_scatter(self, axesparams, params, upper):
    ...
    def test_contour_plot_2d(self, contour_plot_2d):
        try:
            fig, ax = plt.subplots()
            np.random.seed(1)
    ...
    @pytest.mark.parametrize('levels', [[0.9],
                                        ...
                                        [0.9, 0.6, 0.3],
                                        [0.9, 0.7, 0.5, 0.3]])
    def test_contour_plot_2d_levels(self, contour_plot_2d, levels):
        try:
            np.random.seed(42)
    ...
    def test_quantile_plot_interval_str(self, sigmas):
